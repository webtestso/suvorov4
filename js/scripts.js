(function($) {
    ...
    var arrLang = {
        'en': {
            ...
            'message2': 'Message',
            'blends_calendar': 'PROUDLY MADE IN MOLDOVA - RECOGNISED AND AWARDED ACROSS THE WORLD',
            ...
            'experience7': 'Work experience 46 years',
            'team8': 'Anatolie Codjebas',
            'position8': 'Winemaker Kazayak-Vin',
            'experience8': 'Work experience 26 years',
            'winemaker': 'Winemakers',
            'winemaker2': 'Best Winemaker of the Republic of Moldova 2019',
            'winemaker3': 'Best Winemaker of the Republic of Moldova 2020',
            'winemaker_info': '«A good wine is like a good movie: it lasts for a moment and leaves a taste of glory in your mouth; it is new in every sip and, like movies, it is born and reborn in every flavor» Likewise, our winemakers, as the most skillful and experienced directors, from year to year, work to create their best creation. And we savor the shots and enjoy the notes of a great work and long for the next time, our Creator will receive another trophy - a Gold Medal!',
            'presentation': 'Company presentation and full range of products:',
            'presentation2': '* Company presentation and full range of products',
            'download': 'Download PDF',
            'knowmore': 'Learn more',
            'videomore': 'Next video/Romanian translation',
            ...
            'about1': 'The holding includes two wine companies "Suvorov - Vin" (2003) and "Kazayak - Vin" (1958). The first association with the "Suvorov - Vin" holding is a wide range of wines and modern technologies. We own 500 hectares of vineyards, located in the southern part of Moldova, where the climate is perfect for quality grape growing. The companies strategy is to reveal to the whole world the exceptional quality of Moldovan wines, through skillful marketing and various cultural aspects of Moldova',
            ...
            'counter2': 'Medals for the past years',
            'counter3': 'Gold medals for the past years',
            'counter4': 'Silver medals for the past years',
        ...
        'ru': {
            ...
            'message2': 'Сообщение',
            'blends_calendar': 'Произведено в Молдове – Признано во всем мире',
            ...
            'experience7': 'Опыт работы 46 лет',
            'team8': 'Анатолий Коджебаш',
            'position8': 'Винодел Kazayak-Vin',
            'experience8': 'Опыт работы 26 лет',
            'winemaker': 'Виноделы',
            'winemaker2': 'Лучший винодел Республики Молдова 2019 года',
            'winemaker3': 'Лучший винодел Республики Молдова 2020 года',
            'winemaker_info': '«Хорошее вино — как хороший фильм: быстро заканчивается, оставляя великолепное послевкусие; с каждым глотком в нем открывается что-то новое, и как это часто бывает с фильмами — оно рождается и возрождается в каждом новом ценителе» Так и наши виноделы, как наиболее искусные и опытные режиссёры, из года в год, трудятся над созданием своего лучшего творения. А мы смакуем кадры и наслаждаемся нотками великого произведения и жаждем, чтобы в следующий раз, наш Творец получил очередной трофей - Золотую медаль!»',
            'presentation': 'Презентация компании и полный ассортимент продукции:',
            'presentation2': '* Презентация компании и полный ассортимент продукции',
            'download': 'Скачать PDF',
            'knowmore': 'Узнать больше',
            'videomore': 'Следующее видео/Румынский перевод',
            ...
            'about1': 'Холдинг включает в себя две винные компании „Suvorov – Vin” (2003г) и „Kazayak – Vin” (1958г). Первая ассоциация с холдингом  „Suvorov – Vin” – это обширная линейка вин и современные технологии. Под нашим владением 500 гектаров виноградников, располагающихся в южной части Молдовы, где климат совершенен для качественного выращивания винограда. Стратегия компании заключается в раскрытии всему миру исключительного качества молдавских вин, через умелый маркетинг и различные культурные аспекты Молдовы',
            ...
            'counter2': 'Медалей за последние года',
            'counter3': 'Золотых медалей за последие года',
            'counter4': 'Серебряных медалей за последние года',
            ...
            'gussy5.2': 'Сочетание вина с едой: Блюда с куриным мясом, брускетта или карри с чечевицей и травами, \nразличные сыры',
            ...
            'vioricaneagra5': 'Сочетание вина с едой: Говядина или баранина на гриле с черным и красным перцем. \nЗапеченная утка с глазурью, зеленой треской, печеными яблоками и добавлением бальзамического уксуса или картофельного пюре. \nШоколадный мусс с черным шоколадом, острым перцем, красным перцем и морской солью',
        ...
        'ro': {
            ...
            'message2': 'Mesaj',
            'blends_calendar': 'PRODUS LOCAL APRECIAT MONDIAL',
            'team1': 'Alexandr Neruh',
            'position1': 'Director',
            ...
            'experience7': 'Experiență profesională 46 de ani',
            'team8': 'Anatolie Codjebas',
            'position8': 'Vinificator Kazayak-Vin',
            'experience8': 'Experiență profesională 26 de ani',
            'winemaker': 'Vinificatori',
            'winemaker2': 'Cel mai bun vinificator al Republicii Moldova 2019',
            'winemaker3': 'Cel mai bun vinificator al Republicii Moldova 2020',
            'winemaker_info': '«Un vin bun este ca un film bun: durează o clipă și îți lasă un post gust de neuitat» Deci vinificatorii noștri, în calitate de regizori cei mai iscusiți și experimentați, de la an la an, lucrează pentru a-și crea cea mai bună creație. Și savurăm fotografiile și ne bucurăm de notele minunatei lucrări și dorim pentru data viitoare, Creatorul nostru va primi un alt trofeu - Medalia de Aur!',
            'presentation': 'Prezentarea companiei și gama completă de produse:',
            'presentation2': '* Prezentarea companiei și gama completă de produse',
            'download': 'Descărcați PDF',
            'knowmore': 'Afla mai mult',
            'videomore': 'Următorul videoclip/Traducere română',
            ...
            'counter2': 'Medalii din ultimii ani',
            'counter3': 'Medalii de aur din ultimii ani',
            'counter4': 'Medalii de argint din ultimii ani',
            ...
            'gussy5.2': 'Combinarea vinurilor cu mâncarea: Feluri de mâncare cu carne de pui, bruschetta sau curry cu linte şi ierburi, \ndiferite brânzeturi',
            ...
            'gussy5.4': 'Combinarea vinurilor cu mâncarea: Preparate de pui cu condimente condimentate, curry şi ierburi, \nbrânzeturi tari',
